...
class QTableWidget(QTableView):
    ...
    cellActivated: QtCore.pyqtSignal(int, int, arguments=['row','column'])
    cellChanged: QtCore.pyqtSignal(int, int, arguments=['row','column'])
    cellClicked: QtCore.pyqtSignal(int, int, arguments=['row','column'])
    cellDoubleClicked: QtCore.pyqtSignal(int, int, arguments=['row','column'])
    cellEntered: QtCore.pyqtSignal(int, int, arguments=['row','column'])
    cellPressed: QtCore.pyqtSignal(int, int, arguments=['row','column'])
    currentCellChanged: QtCore.pyqtSignal(int, int, int, int, arguments=['currentRow', 'currentColumn', 'previousRow', 'previousColumn'])
    currentItemChanged: QtCore.pyqtSignal(QTableWidgetItem, QTableWidgetItem, arguments=['current', 'previous'])
    itemActivated: QtCore.pyqtSignal(QTableWidgetItem, arguments=['item'])
    itemChanged: QtCore.pyqtSignal(QTableWidgetItem, arguments=['item'])
    itemClicked: QtCore.pyqtSignal(QTableWidgetItem, arguments=['item'])
    # itemClicked: QtCore.pyqtSignal(QTableWidgetItem, arguments=['item'])
    itemDoubleClicked: QtCore.pyqtSignal(QTableWidgetItem, arguments=['item'])
    itemEntered: QtCore.pyqtSignal(QTableWidgetItem, arguments=['item'])
    itemPressed: QtCore.pyqtSignal(QTableWidgetItem, arguments=['item'])
    itemSelectionChanged: QtCore.pyqtSignal()
